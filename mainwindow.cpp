...
{
    if (!m_trayIcon) {
        m_trayIcon = new QSystemTrayIcon(QIcon("icons/sun.svg"), this);
        m_trayIcon->setToolTip("Peerly Research Platform");
        m_trayIcon->show();
    }
}
...
void MainWindow::buildCreateReviewUI()
{
    ...
    struct SliceData { int value; QColor color; QString label; };
    ...
    struct DonutPainter : public QObject {
        ...
        bool eventFilter(QObject* obj, QEvent* ev) override {
            if (ev->type() == QEvent::Paint) {
                ...
                int cx = w->width() / 2, cy = w->height() / 2 - 10;
                int outerR = 72, innerR = 44;
    ...
    dp->dark       = dark;
    dp->txtPrimary = capturedTxtPrimary;
...
void MainWindow::showConferenceMap(const QString& location, const QString& title)
{
    ...
    QObject::connect(geoReply, &QNetworkReply::finished, this, [=]() {
        ...
        QStringList args = { "--app=" + url, "--window-size=900,650" };

        #ifdef Q_OS_WIN
        QStringList browsers = {
            "C:/Program Files/Google/Chrome/Application/chrome.exe",
            "C:/Program Files (x86)/Google/Chrome/Application/chrome.exe",
            qgetenv("LOCALAPPDATA") + "/Google/Chrome/Application/chrome.exe",
            "C:/Program Files/Chromium/Application/chrome.exe",
            "C:/Program Files (x86)/Chromium/Application/chrome.exe",
            qgetenv("LOCALAPPDATA") + "/Chromium/Application/chrome.exe"
        };
        #else
        QStringList browsers = {
            "chromium",
